...
export default async function PointsPage() {
  ...
  return (
    <div className="min-h-screen px-4 pt-6">
      <div className="mb-4">
        <h1 className="text-2xl font-black text-slate-900 dark:text-white">🏆 Points</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400">Bonus points from games &amp; adventures</p>
      </div>
